...
ALTER TABLE address
    ADD CONSTRAINT address_uq UNIQUE ( address_street,
                                       address_town,
                                       address_pcode,
                                       country_code );
...
ALTER TABLE manifest ADD CONSTRAINT manifest_uq UNIQUE ( passenger_id,
                                                         cruise_id );
...
COMMENT ON COLUMN passenger.guardian_id IS
    'Unique identifier for guardian of passenger';
